...
The author concludes that the major goals set up in the first chapter could be achieved. Nevertheless there are some open issues which could be resolved in future research or thesis works. The following aspects are left open:
