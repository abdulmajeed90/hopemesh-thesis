...
\subsubsection{Test \#6}% {{{4
\begin{figure}[H]
  \begin{center}
    \includegraphics[]{figures/test6}
  \end{center}
  \caption{Route simulation test \#6}
\end{figure}

\begin{lstlisting}[label=sim:test1,caption=Output of Test \#6]
\end{lstlisting}

\subsubsection{Test \#7}% {{{4
\begin{lstlisting}[label=sim:test1,caption=Output of Test \#7]
\end{lstlisting}

\subsubsection{Test \#8}% {{{4
\begin{lstlisting}[label=sim:test1,caption=Output of Test \#8]
\end{lstlisting}
...
\subsubsection{Test \#10}% {{{4
\begin{figure}[H]
  \begin{center}
    \includegraphics[]{figures/test10}
  \end{center}
  \caption{Route simulation test \#10}
\end{figure}

\begin{lstlisting}[label=sim:test1,caption=Output of Test \#10]
\end{lstlisting}

\subsubsection{Test \#11}% {{{4
\begin{figure}[H]
  \begin{center}
    \includegraphics[]{figures/test11}
  \end{center}
  \caption{Route simulation test \#11}
\end{figure}

\begin{lstlisting}[label=sim:test1,caption=Output of Test \#11]
\end{lstlisting}
